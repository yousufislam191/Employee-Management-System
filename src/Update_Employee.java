...
class Update_Employee extends JFrame {
    ...
    private JFrame f;
    private JLabel id1, id2, id3, id4, id5, id6, id7, id8, id9, id10, id11, id12, id13, id14, id15, id16, id17, lab,
            lab1;
    ...
    Update_Employee(String id) {
        ...
        b.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    DbConnect db = new DbConnect();
                    String queryInsert = "UPDATE `employeeregistration` SET `joiningdate`='" + t8.getText()
                            + "',`position`='" + t9.getText() + "',`salary`='" + t10.getText() + "',`duitytime`='"
                            + t12.getText() + "',`branch`='" + t13.getText() + "' WHERE id='" + id + "'";
